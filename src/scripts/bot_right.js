...
function insertRightBotUI() {
	const html =
	  `<div id="botUi" class="bot-ui-right"><div id="closeBot" class="close-chat">X</div><object type="text/html" data="http://localhost:3001/?${window.location.hostname}" class="bot-input-right"></object></div>`;
